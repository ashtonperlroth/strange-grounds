...
function BentoGrid({ items = itemsSample, children, className }: BentoGridProps) {
    if (children) {
        return (
...
function BentoCard({ children, className }: { children: React.ReactNode; className?: string }) {
    return (
        <div className={cn("group relative p-4 rounded-xl overflow-hidden transition-all duration-300", className)}>
            {children}
        </div>
    );
}
