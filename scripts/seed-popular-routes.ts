...
const SPRING_SUMMER_ROUTES: RouteInput[] = [
  {
    ...
    totalDistanceM: 339477,
    elevationGainM: 13411,
    elevationLossM: 13716,
    maxElevationM: 4009,
    minElevationM: 1219,
    activity: "backpacking",
    difficulty: "strenuous",
    ...
    state: "CA",
    bestMonths: [7, 8, 9],
    seasonNotes: "Late July through September. Snow on passes in early July. Permits extremely competitive—apply early.",
    estimatedDays: 21.0,
    permitRequired: true,
    permitInfo: "Yosemite wilderness permit required. Whitney Portal permit separate. Both through recreation.gov.",
    trailheadName: "Happy Isles Trailhead (Yosemite Valley)",
    trailheadCoords: [-119.5590, 37.7459],
    isFeatured: true,
    metaTitle: "John Muir Trail (JMT) Thru-Hike Guide",
    metaDescription:
      "Plan your John Muir Trail thru-hike. 211 miles through the Sierra Nevada. Permits, conditions, and planning.",
    waypoints: [
      { sortOrder: 1, name: "Happy Isles Trailhead", coords: [-119.5590, 37.7459], elevationM: 1219, waypointType: "start", description: "Start from Happy Isles in Yosemite Valley. Permit required." },
      { sortOrder: 2, name: "Tuolumne Meadows", coords: [-119.3200, 37.8900], elevationM: 2621, waypointType: "waypoint", description: "Major resupply point. Tuolumne Meadows store and post office." },
      { sortOrder: 3, name: "Muir Pass", coords: [-118.7500, 37.8000], elevationM: 3657, waypointType: "pass", description: "One of the highest passes on the JMT. Historic Muir Hut at the summit." },
      { sortOrder: 4, name: "Forester Pass", coords: [-118.4100, 36.8300], elevationM: 4009, waypointType: "pass", description: "Highest point on the JMT/PCT at 13,153 feet. Snow through late July." },
      { sortOrder: 5, name: "Mount Whitney Summit", coords: [-118.2920, 36.5786], elevationM: 4421, waypointType: "end", description: "Southern terminus. Highest point in the lower 48 at 14,505 feet." },
    ],
  },
  {
    slug: "half-dome-cables",
    name: "Half Dome via Cables",
    description:
      "Half Dome is the most iconic hike in Yosemite National Park and one of the most recognizable summits in the world. The cables route from Yosemite Valley to the summit and back is a strenuous 14-16 mile day hike gaining nearly 4,800 feet, with the final 400 feet on steel cables bolted into the granite dome.\n\nThe cables are installed each spring (typically late May) and removed in fall (October). Without the cables, the final section is a technical climb. The permit system limits daily visitors to protect both the resource and safety.\n\nThunderstorms are the primary hazard. The summit is fully exposed and lightning strikes have killed hikers on the cables. The park service recommends starting before dawn to summit by midday and descend before afternoon storms build. Check the forecast—if thunderstorms are predicted, turn back.\n\nThe trail climbs through Yosemite Valley forest, past Nevada and Vernal Falls, through the Little Yosemite Valley, and up the Sub Dome steps before the cables. The sub-dome switchbacks and cables section require hand-over-hand climbing on a steep granite slab. Gloves are strongly recommended.",
    coordinates: [
      [-119.5590, 37.7359],
      [-119.5500, 37.7300],
      [-119.5400, 37.7200],
    ...
    state: "CA",
    bestMonths: [6, 7, 8, 9, 10],
    seasonNotes: "Cables installed late May through October. Start before dawn to avoid afternoon thunderstorms. Lightning is the main hazard.",
    estimatedDays: 1.0,
    permitRequired: true,
    permitInfo: "Day hike permit required through recreation.gov lottery. Apply 2 days before or 7 days before via advance lottery.",
    trailheadName: "Happy Isles Trailhead",
    trailheadCoords: [-119.5590, 37.7359],
    isFeatured: true,
    metaTitle: "Half Dome Cables Route Hike Guide",
    metaDescription:
      "Plan your Half Dome day hike in Yosemite. Permit info, cables conditions, and thunderstorm safety.",
    waypoints: [
      { sortOrder: 1, name: "Happy Isles Trailhead", coords: [-119.5590, 37.7359], elevationM: 1219, waypointType: "start", description: "Start from Happy Isles. Arrive early—the shuttle from Curry Village begins at 7am." },
      { sortOrder: 2, name: "Vernal Fall", coords: [-119.5480, 37.7270], elevationM: 1524, waypointType: "waypoint", description: "First major landmark. Mist Trail goes right; John Muir Trail goes left." },
      { sortOrder: 3, name: "Nevada Fall", coords: [-119.5400, 37.7220], elevationM: 1921, waypointType: "waypoint", description: "Top of Nevada Fall. Views of Liberty Cap. Little Yosemite Valley ahead." },
      { sortOrder: 4, name: "Sub Dome Junction", coords: [-119.5200, 37.7430], elevationM: 2591, waypointType: "waypoint", description: "Permit check station. Rangers check your permit here. 400 feet of cables ahead." },
      { sortOrder: 5, name: "Half Dome Summit", coords: [-119.5180, 37.7460], elevationM: 2694, waypointType: "end", description: "The summit. Views in all directions. Turn back if thunderstorms are building." },
    ],
  },
  {
    slug: "mount-whitney-main-trail",
    name: "Mount Whitney Main Trail",
    description:
      "The Mount Whitney Trail from Whitney Portal is the standard route to the summit of the highest peak in the contiguous United States at 14,505 feet. The 11-mile trail (one way) gains 6,100 feet through pine forests, past alpine lakes, and across granite boulder fields to the summit plateau.\n\nThe trail is one of the most heavily used wilderness corridors in the country. Whitney Portal sells out permits almost instantly when the lottery opens. Day hikers can make the round trip in 8-12 hours for fit hikers starting at 3am; overnight backpackers typically camp at Outpost Camp or Trail Camp.\n\nAltitude sickness is the primary hazard, especially for hikers coming from sea level. Acclimate by spending a night at Whitney Portal (8,365 ft) before attempting the summit. Snow crosses the trail above Trail Camp through mid-July most years, and the 99 Switchbacks can be icy in early season requiring microspikes or crampons.\n\nThunderstorms build almost daily in July and August. The summit must be reached by noon to safely descend before afternoon lightning. The trail is well-marked and heavily trafficked.",
    coordinates: [
      [-118.2397, 36.5860],
      [-118.2600, 36.5810],
      [-118.2800, 36.5790],
    ...
    state: "CA",
    bestMonths: [7, 8, 9],
    seasonNotes: "July through September. Snow on trail in June and early July. Permits required—lottery opens in February.",
    estimatedDays: 1.0,
    permitRequired: true,
    permitInfo: "Permit required May 1–Nov 1 through recreation.gov. Overnight permits need bear canister.",
    trailheadName: "Whitney Portal",
    trailheadCoords: [-118.2397, 36.5860],
    isFeatured: true,
    metaTitle: "Mount Whitney Trail Guide — Main Trail",
    metaDescription:
      "Hike Mount Whitney via the Main Trail from Whitney Portal. Permit info, altitude tips, and conditions.",
    waypoints: [
      { sortOrder: 1, name: "Whitney Portal", coords: [-118.2397, 36.5860], elevationM: 2548, waypointType: "start", description: "Start at Whitney Portal. Store, campground, and parking. Trailhead sign here." },
      { sortOrder: 2, name: "Outpost Camp", coords: [-118.2700, 36.5820], elevationM: 3505, waypointType: "camp", description: "First designated camping area. Good acclimatization stop." },
      { sortOrder: 3, name: "Trail Camp", coords: [-118.2850, 36.5790], elevationM: 3962, waypointType: "camp", description: "Main overnight camp before the summit push. Toilet facilities." },
      { sortOrder: 4, name: "Trail Crest (99 Switchbacks)", coords: [-118.2920, 36.5760], elevationM: 4270, waypointType: "pass", description: "Top of the 99 Switchbacks. Often icy in early season. Views of the Owens Valley." },
      { sortOrder: 5, name: "Mount Whitney Summit", coords: [-118.2920, 36.5786], elevationM: 4421, waypointType: "end", description: "Summit! Highest point in the contiguous US at 14,505 feet. Summit hut for shelter." },
    ],
  },
  {
    slug: "high-sierra-trail",
    name: "High Sierra Trail",
    description:
      "The High Sierra Trail is one of the finest trans-Sierra routes, traversing 72 miles from Crescent Meadow in Sequoia National Park to the summit of Mount Whitney. The trail offers a complete Sierra experience—giant sequoias, deep river canyons, high alpine terrain, and the highest peak in the lower 48.\n\nUnlike the more crowded JMT, the HST sees a fraction of the foot traffic despite comparable scenery. The trail begins in the Giant Forest near Crescent Meadow, drops into the Kern River canyon (one of the deepest in the US), and climbs back up to Whitney through the Guitar Lake basin.\n\nThe trail crosses several streams that can be challenging in early season snowmelt—particularly in June. Rattlesnakes are common in the lower canyon sections. The final approach to Whitney involves the same summit plateau as the main Whitney trail.\n\nMost hikers complete the HST in 8-12 days. Permits are required from both the Sequoia and Inyo National Forest sides. The route is well-maintained but gets minimal maintenance compared to the JMT, so expect some blowdowns after winter storms.",
    coordinates: [
      [-118.7500, 36.5680],
      [-118.6500, 36.5200],
      [-118.5700, 36.5100],
    ...
    state: "CA",
    bestMonths: [7, 8, 9],
    seasonNotes: "July through September. Stream crossings high in June. Permits from Sequoia NP.",
    estimatedDays: 10.0,
    permitRequired: true,
    permitInfo: "Sequoia NP wilderness permit from Lodgepole Visitor Center. recreation.gov advance reservations.",
    trailheadName: "Crescent Meadow (Sequoia NP)",
    trailheadCoords: [-118.7500, 36.5680],
    isFeatured: false,
    metaTitle: "High Sierra Trail Backpacking Guide",
    metaDescription:
      "Plan the 72-mile High Sierra Trail from Sequoia NP to Mount Whitney. Permits, conditions, and logistics.",
    waypoints: [
      { sortOrder: 1, name: "Crescent Meadow Trailhead", coords: [-118.7500, 36.5680], elevationM: 1920, waypointType: "start", description: "Start near the giant sequoias of the Giant Forest. Stunning beginning to the route." },
      { sortOrder: 2, name: "Hamilton Lakes", coords: [-118.5700, 36.5100], elevationM: 2927, waypointType: "waypoint", description: "Beautiful alpine lakes with dramatic views of Kaweah Peaks Ridge." },
      { sortOrder: 3, name: "Kern Hot Spring", coords: [-118.5200, 36.5100], elevationM: 1920, waypointType: "waypoint", description: "Natural hot spring in the Kern River canyon. Rest day destination." },
      { sortOrder: 4, name: "Guitar Lake", coords: [-118.3500, 36.5600], elevationM: 3489, waypointType: "camp", description: "Alpine base camp for Whitney summit. Named for its shape." },
      { sortOrder: 5, name: "Mount Whitney Summit", coords: [-118.2920, 36.5786], elevationM: 4421, waypointType: "end", description: "Eastern terminus. Summit of the highest peak in the contiguous US." },
    ],
  },
  {
    slug: "timberline-trail-mt-hood",
    name: "Timberline Trail — Mt. Hood",
    description:
      "The Timberline Trail is a 41-mile loop circumnavigating Mount Hood in Oregon, staying high on the volcano's flanks between 5,400 and 7,300 feet. The trail passes through alpine meadows, crosses glacial streams, and skirts the lower edges of Mount Hood's multiple glaciers—offering a complete perspective of the volcano from every angle.\n\nStream crossings are the defining challenge. Sandy River, Eliot Branch, and Ladd Creek can be dangerous in early season snowmelt, typically peaking in late June. By August, most crossings are manageable. Some years, Sandy River requires a rope system as late as July.\n\nThe trail passes the historic Timberline Lodge on the south side—an excellent mid-route resupply and rest stop. The Paradise Park section on the southwest offers some of the best wildflower meadows in the Pacific Northwest, peaking in July and August.\n\nMost hikers complete the loop in 3-5 days. Some ambitious runners do it in a single day (under 24 hours). The Eliot Glacier crossing on the north side can require an ice axe in early season. Views of Hood's summit are spectacular from all sides, weather permitting.",
    coordinates: [
      [-121.7087, 45.3311],
      [-121.7600, 45.3500],
      [-121.8000, 45.3800],
    ...
    state: "OR",
    bestMonths: [7, 8, 9],
    seasonNotes: "July through September. Glacial stream crossings dangerous in June. Sandy River can require rope in early July.",
    estimatedDays: 4.0,
    permitRequired: false,
    permitInfo: "No permit required. Self-registration at trailhead. Camp at designated sites only.",
    trailheadName: "Timberline Lodge",
    trailheadCoords: [-121.7087, 45.3311],
    isFeatured: false,
    metaTitle: "Timberline Trail Mt. Hood Backpacking Guide",
    metaDescription:
      "Hike the Timberline Trail around Mt. Hood. 41-mile loop with glacial stream crossings and alpine meadows.",
    waypoints: [
      { sortOrder: 1, name: "Timberline Lodge", coords: [-121.7087, 45.3311], elevationM: 1829, waypointType: "start", description: "Historic 1937 WPA lodge. Excellent starting point with resupply options." },
      { sortOrder: 2, name: "Paradise Park", coords: [-121.7600, 45.3500], elevationM: 1966, waypointType: "waypoint", description: "Spectacular wildflower meadows. One of the most beautiful sections." },
      { sortOrder: 3, name: "Sandy River Crossing", coords: [-121.8200, 45.3950], elevationM: 1676, waypointType: "waypoint", description: "The most dangerous crossing on the route. Can be thigh-deep in early July." },
      { sortOrder: 4, name: "Eliot Branch", coords: [-121.7200, 45.4000], elevationM: 1829, waypointType: "waypoint", description: "Glacial meltwater crossing on the north side. Cold and fast in early season." },
      { sortOrder: 5, name: "Return to Timberline", coords: [-121.7087, 45.3311], elevationM: 1829, waypointType: "end", description: "Complete the circumnavigation back to Timberline Lodge." },
    ],
  },
  {
    slug: "glacier-national-park-highline",
    name: "Glacier NP — Highline Trail to Granite Park",
    description:
      "The Highline Trail traverses the Continental Divide from Logan Pass to Granite Park Chalet, following a spectacular ledge cut into a cliff face with views of the Livingston Range and the Going-to-the-Sun Road far below. This is the signature day hike of Glacier National Park.\n\nThe trail begins at Logan Pass (6,646 ft) with a famous traverse along a narrow ledge with a cable assist—intimidating but not technical. Beyond the ledge, the trail opens into vast alpine terrain: glacial cirques, mountain goats, grizzly bears, and wildflowers stretching to the horizon.\n\nThe chalet at Granite Park (7,600 ft) is a highlight—stone buildings perched on a ridge with glacier views and a shuttle option back to the Going-to-the-Sun Road. Most hikers do this as a 16-mile one-way trip with a shuttle.\n\nSmoke from late-season fires (August-September) is increasingly common and can obscure views. Fire information is posted daily at the visitor center. Snow remains on the trail at Logan Pass well into June most years.",
    coordinates: [
      [-113.7178, 48.6958],
      [-113.7400, 48.7100],
      [-113.7600, 48.7300],
    ...
    state: "MT",
    bestMonths: [7, 8, 9],
    seasonNotes: "July through September. Snow at Logan Pass in June. Smoke possible August-September. Check fire status.",
    estimatedDays: 1.0,
    permitRequired: false,
    permitInfo: "Vehicle reservation required for Logan Pass parking May-Oct. Book through recreation.gov.",
    trailheadName: "Logan Pass Visitor Center",
    trailheadCoords: [-113.7178, 48.6958],
    isFeatured: true,
    metaTitle: "Glacier NP Highline Trail Hike Guide",
    metaDescription:
      "Hike the Highline Trail in Glacier National Park from Logan Pass to Granite Park Chalet.",
    waypoints: [
      { sortOrder: 1, name: "Logan Pass Visitor Center", coords: [-113.7178, 48.6958], elevationM: 2025, waypointType: "start", description: "Starting point at Logan Pass. Arrive early for parking—fills by 9am in July." },
      { sortOrder: 2, name: "Highline Ledge Traverse", coords: [-113.7300, 48.7050], elevationM: 2090, waypointType: "waypoint", description: "The famous exposed ledge. Cable assist available. Look out for mountain goats." },
      { sortOrder: 3, name: "Grinnell Glacier Overlook", coords: [-113.7600, 48.7300], elevationM: 2200, waypointType: "waypoint", description: "Side trail to overlook of Grinnell Glacier. Well worth the extra 0.5 miles." },
      { sortOrder: 4, name: "Granite Park Chalet", coords: [-113.8000, 48.7600], elevationM: 2317, waypointType: "end", description: "Historic stone chalet at 7,600 feet. Shuttle available back to the Going-to-the-Sun Road." },
    ],
  },
  {
    ...
    description:
      "Cascade Pass is one of the most spectacular day hikes in the North Cascades, rising through old-growth forest to a flower-filled alpine pass at 5,392 feet with dramatic views of glaciated peaks. The optional extension up Sahale Arm adds 1,600 feet more to a rocky ridge with views of the Cascade Glacier.\n\nThe 3.7-mile trail to Cascade Pass gains 1,800 feet through dense fir and hemlocks before breaking out above treeline near the pass. The meadows around the pass are carpeted with wildflowers in July—lupine, paintbrush, and aster in vivid color against grey granite and white glacier ice.\n\nFrom Cascade Pass, the Sahale Arm trail continues up a steep spine with no shade and no water. The arm culminates at 7,600 feet with views that include Boston Peak, Buckner Mountain, and the intricate crevasse systems of the Quien Sabe Glacier.\n\nThe area sees significant snow through mid-July and the road to the trailhead doesn't open until snowpack melts, typically mid-June. Bears and marmots are common. The remote location (Cascade River Road from Marblemount) means limited cell service and self-reliance is essential.",
    coordinates: [
      [-121.0680, 48.4780],
      [-121.0550, 48.4820],
      [-121.0450, 48.4860],
    ...
    state: "WA",
    bestMonths: [7, 8, 9, 10],
    seasonNotes: "Road opens mid-June. Snow on Sahale Arm through July. Best wildflowers in July. Fall color in October.",
    estimatedDays: 1.0,
    permitRequired: false,
    permitInfo: "No permit for day use. Overnight camping requires backcountry permit from North Cascades NP.",
    trailheadName: "Cascade Pass Trailhead",
    trailheadCoords: [-121.0680, 48.4780],
    isFeatured: false,
    metaTitle: "Cascade Pass & Sahale Arm Hiking Guide",
    metaDescription:
      "Hike Cascade Pass and Sahale Arm in the North Cascades. Wildflowers, glaciers, and mountain views.",
    waypoints: [
      { sortOrder: 1, name: "Cascade Pass Trailhead", coords: [-121.0680, 48.4780], elevationM: 868, waypointType: "start", description: "Road ends here after the long Cascade River Road approach. 3.7 miles to the pass." },
      { sortOrder: 2, name: "Cascade Pass", coords: [-121.0340, 48.4920], elevationM: 1644, waypointType: "waypoint", description: "Historic Native American travel route across the Cascades. Views of Pelton Peak and Magic Mountain." },
      { sortOrder: 3, name: "Sahale Arm High Point", coords: [-121.0150, 48.5020], elevationM: 2316, waypointType: "end", description: "Top of the arm. Glacier views. Backcountry campers can continue to Sahale Glacier Camp." },
    ],
  },
  {
    slug: "tahoe-rim-trail-thru",
    name: "Tahoe Rim Trail",
    description:
      "The Tahoe Rim Trail is a 170-mile loop encircling Lake Tahoe at elevations between 6,300 and 10,338 feet, offering some of the most varied high-country scenery in the Sierra Nevada and Great Basin. The trail crosses through Desolation Wilderness, the Carson Range, and the Nevada high desert, presenting dramatically different terrain on each segment.\n\nThe trail is usually attempted as a multi-week backpacking trip, though some ultra-runners complete it in under 72 hours. The two main challenges are the Desolation Wilderness permit quota (highly competitive in July-August) and the lack of water on the Nevada side where springs can be miles apart.\n\nSnow covers the highest points—the Freel Peak area near Echo Summit and the Carson Pass region—well into June. The full route doesn't become consistently snow-free until early July. Wildflowers peak in the Desolation Wilderness in July; fall color appears in September.\n\nThe lake itself is visible from many high points, shimmering blue-green far below. The Nevada side offers solitude and wide-open views of the Great Basin. The California side through Desolation Wilderness is the most dramatic—granite, lakes, and alpine terrain rivaling anything in the Sierra.",
    coordinates: [
      [-120.0324, 39.0968],
      [-120.1200, 39.2000],
      [-120.0500, 39.3000],
    ...
    totalDistanceM: 273588,
    elevationGainM: 10058,
    elevationLossM: 10058,
    maxElevationM: 3151,
    minElevationM: 1920,
    activity: "backpacking",
    difficulty: "strenuous",
    ...
    state: "CA/NV",
    bestMonths: [7, 8, 9],
    seasonNotes: "July through September. Snow on high points in June. Desolation Wilderness permit required—limited quota.",
    estimatedDays: 14.0,
    permitRequired: true,
    permitInfo: "Desolation Wilderness permit required for overnight travel in that section. recreation.gov.",
    trailheadName: "Tahoe City (North Shore)",
    trailheadCoords: [-120.0324, 39.0968],
    isFeatured: false,
    metaTitle: "Tahoe Rim Trail Thru-Hike Guide",
    metaDescription:
      "Hike the 170-mile Tahoe Rim Trail around Lake Tahoe. Permit info, conditions, and season planning.",
    waypoints: [
      { sortOrder: 1, name: "Tahoe City Trailhead", coords: [-120.0324, 39.0968], elevationM: 1897, waypointType: "start", description: "Common starting point on the north shore of Lake Tahoe." },
      { sortOrder: 2, name: "Desolation Wilderness Entry", coords: [-120.1200, 39.2000], elevationM: 2438, waypointType: "waypoint", description: "Enter Desolation Wilderness. Permit required beyond this point overnight." },
      { sortOrder: 3, name: "Freel Peak Area", coords: [-119.9000, 39.3500], elevationM: 3151, waypointType: "waypoint", description: "Highest point on the trail near Freel Peak (10,880 ft). Views of Tahoe and Great Basin." },
      { sortOrder: 4, name: "Carson Pass", coords: [-119.8000, 39.2500], elevationM: 2895, waypointType: "waypoint", description: "Highway 88 crossing. Resupply at Caples Lake Resort." },
      { sortOrder: 5, name: "Return to Tahoe City", coords: [-120.0324, 39.0968], elevationM: 1897, waypointType: "end", description: "Complete the loop." },
    ],
  },
  {
    slug: "angeles-landing-zion",
    name: "Angels Landing",
    description:
      "Angels Landing is the signature hike of Zion National Park—a vertiginous scramble up chains and rock to a narrow sandstone fin 1,488 feet above the valley floor. The final half-mile to the summit requires hand-over-hand scrambling on chains bolted into the cliff face, with steep drop-offs on both sides.\n\nThe route climbs relentlessly from the canyon floor, first ascending a paved trail, then ascending Walter's Wiggles—21 short steep switchbacks cut directly into the cliff face—before reaching Scout Lookout. Most hikers stop at Scout Lookout, which offers exceptional views. Beyond Scout Lookout, the chains section is for those comfortable with exposure.\n\nPeople have died on Angels Landing. The falls have been from both the chains section and the summit plateau. Don't attempt in wet or icy conditions. The park service installed a permit system to reduce crowding on the chains section and improve safety.\n\nThe best times are spring and fall when temperatures are moderate. Summer is brutally hot—start at dawn. October-April has the lowest crowds but the chains can be icy after rain or snow.",
    coordinates: [
      [-112.9503, 37.2677],
      [-112.9520, 37.2700],
      [-112.9510, 37.2730],
    ...
    seasonNotes: "Spring and fall best. Summer too hot—start at dawn. Chains icy after rain/snow. Permit required for chains section.",
    estimatedDays: 1.0,
    permitRequired: true,
    permitInfo: "Permit required for the chains section beyond Scout Lookout. Day-before lottery and advance lottery at recreation.gov.",
    trailheadName: "Grotto Trailhead",
    trailheadCoords: [-112.9503, 37.2677],
    isFeatured: true,
    metaTitle: "Angels Landing Hike Guide — Zion National Park",
    metaDescription:
      "Plan your Angels Landing hike in Zion. Permit info, chains section, and conditions.",
    waypoints: [
      { sortOrder: 1, name: "Grotto Trailhead", coords: [-112.9503, 37.2677], elevationM: 1219, waypointType: "start", description: "Start from the Grotto picnic area. Take the Zion Canyon shuttle to the Grotto stop." },
      { sortOrder: 2, name: "Walters Wiggles", coords: [-112.9510, 37.2730], elevationM: 1646, waypointType: "waypoint", description: "21 brutal switchbacks cut into the cliff. The relentless climb before the views." },
      { sortOrder: 3, name: "Scout Lookout", coords: [-112.9490, 37.2745], elevationM: 1707, waypointType: "waypoint", description: "Many hikers turn around here. Views are already spectacular. Chains begin beyond." },
      { sortOrder: 4, name: "Angels Landing Summit", coords: [-112.9477, 37.2760], elevationM: 1763, waypointType: "end", description: "Narrow summit fin. 1,488 feet above the canyon floor. Views in all directions." },
    ],
  },
  {
    slug: "the-narrows-zion",
    name: "The Narrows — Zion",
    description:
      "The Narrows is a slot canyon hike through the Virgin River in Zion National Park, wading upstream through a canyon only 20 feet wide at its narrowest, with walls rising 1,000 feet on either side. It is one of the most unique hike experiences in the American West—more swimming and wading than walking.\n\nThe classic hike enters from the bottom of the canyon at the Temple of Sinawava and follows the river upstream as far as desired. The top-down route from Chamberlain's Ranch is 16 miles one-way with a permit and shuttle. Most hikers do a 4-8 mile out-and-back from the bottom.\n\nThe primary hazard is flash flooding. The canyon has no escape routes for large sections, and storms anywhere in the watershed—including storms 100 miles north—can send a wall of water down the canyon with little warning. Check the flash flood forecast at the visitor center. The park closes the Narrows if the flood risk is elevated.\n\nWater temperature averages 68°F in summer. Dry suits are rented near the park entrance for cold months. Trekking poles and canyoneering shoes dramatically improve stability on the slippery cobbles. Wildlife includes herons, canyon wrens, and the occasional water snake.",
    coordinates: [
      [-112.9477, 37.2992],
      [-112.9477, 37.3100],
      [-112.9480, 37.3250],
    ...
    state: "UT",
    bestMonths: [5, 6, 7, 8, 9, 10],
    seasonNotes: "May through October. Flash flood risk—always check forecast. Spring runoff can make water too high in May.",
    estimatedDays: 1.0,
    permitRequired: false,
    permitInfo: "Bottom-up day hike requires no permit. Top-down overnight requires permit from recreation.gov.",
    trailheadName: "Temple of Sinawava",
    trailheadCoords: [-112.9477, 37.2992],
    isFeatured: true,
    metaTitle: "The Narrows Zion Hike Guide",
    metaDescription:
      "Plan your Narrows hike in Zion National Park. Flash flood risk, wading, and gear recommendations.",
    waypoints: [
      { sortOrder: 1, name: "Temple of Sinawava", coords: [-112.9477, 37.2992], elevationM: 1219, waypointType: "start", description: "Shuttle stop at the end of the Zion Canyon Scenic Drive. Paved 1-mile Riverside Walk to water entry." },
      { sortOrder: 2, name: "Riverside Walk End / Water Entry", coords: [-112.9477, 37.3050], elevationM: 1229, waypointType: "waypoint", description: "End of the paved trail. Enter the river and wade upstream." },
      { sortOrder: 3, name: "Wall Street", coords: [-112.9480, 37.3250], elevationM: 1250, waypointType: "waypoint", description: "The narrowest section—walls just 20 feet apart, 1,000 feet tall. The iconic photo spot." },
      { sortOrder: 4, name: "Big Spring (turnaround)", coords: [-112.9475, 37.3400], elevationM: 1280, waypointType: "end", description: "Natural spring emerging from the canyon wall. Common turnaround for bottom-up hikers." },
    ],
  },
  {
    slug: "havasupai-falls",
    name: "Havasupai Falls",
    description:
      "Havasupai Falls is one of the most photographed natural wonders in North America—turquoise blue-green waterfalls tumbling into travertine pools deep in a side canyon of the Grand Canyon, located on the Havasupai tribal lands. The 10-mile trail drops 2,000 feet into Havasu Canyon to reach Supai Village and the campground beyond.\n\nThe falls are formed by travertine deposits from the calcium-rich spring water. Havasu Falls (100 ft), Mooney Falls (200 ft), and Beaver Falls (downstream) are the three main cascades. The water color comes from the high calcium carbonate content, which scatters light to create the vivid turquoise hue.\n\nThe permit system is managed by the Havasupai Tribe. Permits are among the most sought-after in the National Park System—a lottery opens each February. No-shows sometimes mean cancellations are available day-of, but planning a year ahead is recommended.\n\nSummer temperatures in the canyon can exceed 110°F. Shade is limited. Most hikers enter in March-May or September-October. Flash floods have damaged the falls infrastructure multiple times—the campground is evacuated when flood risk is elevated.",
    coordinates: [
      [-112.6980, 36.2559],
      [-112.7000, 36.2400],
      [-112.7100, 36.2200],
    ...
    activity: "backpacking",
    difficulty: "moderate",
    region: "Grand Canyon / Havasupai",
    state: "AZ",
    bestMonths: [3, 4, 5, 9, 10],
    seasonNotes: "Spring and fall best. Summer 110°F+ in the canyon. Flash flood risk—camps can be evacuated. Permits are extremely competitive.",
    estimatedDays: 2.0,
    permitRequired: true,
    permitInfo: "Havasupai Tribe permit required. Lottery opens February each year. Very limited availability.",
    trailheadName: "Hualapai Hilltop",
    trailheadCoords: [-112.6980, 36.2559],
    isFeatured: true,
    metaTitle: "Havasupai Falls Backpacking Guide",
    metaDescription:
      "Plan your Havasupai Falls backpacking trip. Permit lottery, trail conditions, and flash flood risk.",
    waypoints: [
      { sortOrder: 1, name: "Hualapai Hilltop", coords: [-112.6980, 36.2559], elevationM: 1676, waypointType: "start", description: "The trailhead at the top of the canyon. 10 miles and 2,000 feet to the campground." },
      { sortOrder: 2, name: "Supai Village", coords: [-112.7100, 36.2200], elevationM: 982, waypointType: "waypoint", description: "The Havasupai village. Check in here. Café and tourist lodge." },
      { sortOrder: 3, name: "Havasu Falls", coords: [-112.7200, 36.2100], elevationM: 976, waypointType: "waypoint", description: "The signature waterfall. 100-foot cascade into a turquoise travertine pool." },
      { sortOrder: 4, name: "Mooney Falls Camp", coords: [-112.7280, 36.2080], elevationM: 969, waypointType: "camp", description: "Campground near 200-foot Mooney Falls. The largest waterfall on the route." },
    ],
  },
  {
    slug: "coyote-gulch",
    name: "Coyote Gulch",
    description:
      "Coyote Gulch is a remote canyon system in Grand Staircase-Escalante National Monument in Utah, featuring natural arches, waterfalls, and ancient ruins in a landscape of red and orange sandstone carved by the Coyote Gulch stream. The 30-35 mile loop is one of the finest canyon backpacking trips in the American Southwest.\n\nThe gulch contains Jacob Hamblin Arch (one of the largest natural arches in Utah), Coyote Natural Bridge, Cliff Arch, and several Ancestral Puebloan granaries tucked in alcoves. The route follows the canyon floor much of the way, requiring occasional wading and scrambling over pour-offs.\n\nThe Escalante River canyon is the downstream terminus, requiring either a long shuttle or a return upstream. Water is available in the creek through most seasons, but pothole water should be treated. The remoteness means no cell service, no rescues without significant helicopter time, and complete self-reliance.\n\nSpring and fall are the sweet spots. Summer thunderstorms bring flash floods—the canyon walls make escape impossible. Winter offers solitude but cold nights. The permit requirement was implemented to reduce impacts on the cryptobiotic soil crust and cultural sites.",
    coordinates: [
      [-111.4200, 37.4800],
      [-111.4400, 37.4600],
      [-111.4600, 37.4400],
    ...
    activity: "backpacking",
    difficulty: "strenuous",
    region: "Grand Staircase-Escalante",
    state: "UT",
    bestMonths: [3, 4, 5, 9, 10],
    seasonNotes: "Spring and fall. Flash flood risk in summer—avoid when storms threaten. No rescues for days in emergency.",
    estimatedDays: 3.0,
    permitRequired: true,
    permitInfo: "GSENM permit required for camping. Quota limits. Apply through recreation.gov.",
    trailheadName: "Red Well Trailhead",
    trailheadCoords: [-111.4200, 37.4800],
    isFeatured: false,
    metaTitle: "Coyote Gulch Backpacking Guide — Escalante",
    metaDescription:
      "Explore Coyote Gulch in Grand Staircase-Escalante. Arches, ruins, and canyon scenery.",
    waypoints: [
      { sortOrder: 1, name: "Red Well Trailhead", coords: [-111.4200, 37.4800], elevationM: 1676, waypointType: "start", description: "Remote trailhead. Long washboard road access. High clearance recommended." },
      { sortOrder: 2, name: "Jacob Hamblin Arch", coords: [-111.4400, 37.4600], elevationM: 1585, waypointType: "waypoint", description: "Massive freestanding arch—one of the largest in Utah. Camping nearby." },
      { sortOrder: 3, name: "Coyote Natural Bridge", coords: [-111.4600, 37.4400], elevationM: 1524, waypointType: "waypoint", description: "Water carved bridge. The stream runs under it during high water." },
      { sortOrder: 4, name: "Escalante River Confluence", coords: [-111.4700, 37.4300], elevationM: 1372, waypointType: "waypoint", description: "Meet the Escalante River. Some parties do a longer loop from here." },
      { sortOrder: 5, name: "Return via Hurricane Wash", coords: [-111.4200, 37.4800], elevationM: 1676, waypointType: "end", description: "Loop back via Hurricane Wash or retrace the gulch." },
    ],
  },
  {
    slug: "wind-river-range-cirque-towers",
    name: "Wind River Range — Cirque of the Towers",
    description:
      "The Cirque of the Towers is a dramatic horseshoe of granite spires in the southern Wind River Range of Wyoming, one of the most spectacular alpine environments in the Rocky Mountains. The 22-mile loop reaches the cirque via Big Sandy Lake and Jackass Pass, surrounded by towers with evocative names—Pingora, Wolf's Head, Warrior, Overhanging Tower.\n\nThe approach from Big Sandy Lodge is 7 miles to Big Sandy Lake, where most hikers camp before continuing over Jackass Pass (10,798 ft) into the cirque basin. The towers are a world-class rock climbing destination, but the non-climbing hiker can experience the full visual spectacle of the granite walls from the meadows below.\n\nThis is true wilderness. No maintained trails in many sections, camp fires prohibited above 9,500 feet, and grizzly bears are present in the drainage. Pack a bear canister and know your bear safety. Snowpack lingers well into July on the north-facing passes.\n\nThe solitude here is profound by western standards—permits are required but quotas are generous. The nearest town is Pinedale, 30+ miles away. Cell service is absent for days at a time.",
    coordinates: [
      [-109.2700, 42.7100],
      [-109.2500, 42.7200],
      [-109.2200, 42.7300],
    ...
    state: "WY",
    bestMonths: [7, 8, 9],
    seasonNotes: "July through September. Snow on passes in June and early July. Grizzly bears present—bear canister required.",
    estimatedDays: 4.0,
    permitRequired: true,
    permitInfo: "Bridger Wilderness permit required. Self-issue at trailhead. Bear canister mandatory.",
    trailheadName: "Big Sandy Lodge Trailhead",
    trailheadCoords: [-109.2700, 42.7100],
    isFeatured: false,
    metaTitle: "Cirque of the Towers Backpacking — Wind Rivers",
    metaDescription:
      "Backpack to the Cirque of the Towers in Wyoming's Wind River Range. Granite spires and alpine wilderness.",
    waypoints: [
      { sortOrder: 1, name: "Big Sandy Lodge Trailhead", coords: [-109.2700, 42.7100], elevationM: 2896, waypointType: "start", description: "Long dirt road from Pinedale. The trailhead for both the Cirque loop and Wind River High Route." },
      { sortOrder: 2, name: "Big Sandy Lake", coords: [-109.2500, 42.7200], elevationM: 2993, waypointType: "camp", description: "Beautiful alpine lake camp. Many hikers spend a night here before the pass." },
      { sortOrder: 3, name: "Jackass Pass", coords: [-109.2200, 42.7300], elevationM: 3292, waypointType: "pass", description: "The crux. Views of the Cirque beyond. Snow through mid-July." },
      { sortOrder: 4, name: "Cirque Basin", coords: [-109.2000, 42.7350], elevationM: 3048, waypointType: "camp", description: "The heart of the Cirque. Pingora, Wolf's Head, and the other towers surround the meadow." },
    ],
  },
  {
    slug: "grand-canyon-bright-angel",
    name: "Grand Canyon — Bright Angel Trail",
    description:
      "The Bright Angel Trail is the most accessible and heavily used corridor trail into the Grand Canyon, descending 9.5 miles from the South Rim (6,860 ft) to the Colorado River (2,480 ft). The trail follows a fault line, providing water at 1.5 and 3-mile rest houses that makes it more hospitable than most canyon routes.\n\nThe most common overnight trip combines Bright Angel with the South Kaibab Trail: descend South Kaibab (steeper, more exposed, no shade, no water), camp at Bright Angel Campground or Phantom Ranch, and ascend Bright Angel. This rim-to-river round trip is 20+ miles with 5,000 feet of elevation change—no small undertaking.\n\nThe primary hazard is heat. The NPS issues \"heat kills\" warnings from May through September and strongly advises against attempting the rim-to-river trip in a single day during summer. Dozens of people require helicopter rescues each year, usually hikers who descended too far and ran out of water.\n\nThe canyon wall geology—600 million years of rock strata exposed in cross-section—is a moving experience. The Vishnu Schist at the bottom is 1.7 billion years old.",
    coordinates: [
      [-112.1428, 36.0572],
      [-112.1430, 36.0450],
      [-112.1450, 36.0300],
    ...
    state: "AZ",
    bestMonths: [3, 4, 5, 9, 10, 11],
    seasonNotes: "Spring and fall. Summer kills—do not hike below the rim in July/August. Winter cold but manageable.",
    estimatedDays: 1.0,
    permitRequired: false,
    permitInfo: "Day hiking requires no permit. Overnight camping (Bright Angel Camp, Phantom Ranch) requires permit from recreation.gov.",
    trailheadName: "Bright Angel Trailhead (South Rim)",
    trailheadCoords: [-112.1428, 36.0572],
    isFeatured: true,
    metaTitle: "Bright Angel Trail Guide — Grand Canyon",
    metaDescription:
      "Hike Bright Angel Trail into the Grand Canyon. Heat safety, conditions, and overnight permit info.",
    waypoints: [
      { sortOrder: 1, name: "Bright Angel Trailhead", coords: [-112.1428, 36.0572], elevationM: 2090, waypointType: "start", description: "South Rim trailhead near Bright Angel Lodge. Water and restrooms." },
      { sortOrder: 2, name: "1.5-Mile Resthouse", coords: [-112.1430, 36.0450], elevationM: 1814, waypointType: "waypoint", description: "Water (May-Sep), shade, and an emergency phone. Turn around here in summer heat." },
      { sortOrder: 3, name: "3-Mile Resthouse", coords: [-112.1450, 36.0300], elevationM: 1524, waypointType: "waypoint", description: "Year-round water, toilets. Many hikers turn around here. Havasupai Gardens visible below." },
      { sortOrder: 4, name: "Indian Garden / Havasupai Gardens", coords: [-112.1480, 36.0200], elevationM: 1158, waypointType: "camp", description: "Campground and ranger station. Cottonwood trees and year-round water. 4.6 miles from rim." },
      { sortOrder: 5, name: "Colorado River / River Trail", coords: [-112.1490, 36.1000], elevationM: 756, waypointType: "end", description: "The river at the bottom. Suspension bridge connects to Phantom Ranch on the north side." },
    ],
  },
];
